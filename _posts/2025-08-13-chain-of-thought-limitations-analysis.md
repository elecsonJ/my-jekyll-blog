...
예를 들어 기존 방식에서는 "카페에 23명이 있었는데, 7명이 나가고 5명이 들어왔다면 지금 몇 명인가?"라는 질문에 단순히 "21명"이라고 답했다면, CoT 방식에서는 "처음에 23명이 있었습니다. 7명이 나갔으므로 23에서 7을 빼면 16명이 남았습니다. 그리고 5명이 들어왔으므로 16에 5를 더하면 21명입니다"와 같이 중간 과정을 상세히 보여줍니다.
