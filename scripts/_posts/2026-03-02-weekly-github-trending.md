...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.03.02)
---
...
**언어:** TypeScript | **⭐ Stars:** 243,092

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 243,092개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 113,599

The open source coding agent.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 113,599개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 96,129

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 96,129개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** None | **⭐ Stars:** 91,886

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,886개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
