...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.05.26)
---
...
**언어:** TypeScript | **⭐ Stars:** 374,654

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 374,654개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Shell | **⭐ Stars:** 206,487

An agentic skills framework & software development methodology that works.

**주요 특징:**
- 최근 주목받고 있는 Shell 프로젝트
- 206,487개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 167,385

The agent that grows with you

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 167,385개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
