...
**언어:** None | **⭐ Stars:** 90,625

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 90,625개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 62,338

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 62,338개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 48,238

No fortress, purely open ground.  OpenManus is Coming.

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 48,238개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
