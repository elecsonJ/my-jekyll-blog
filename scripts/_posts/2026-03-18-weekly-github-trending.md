...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.03.18)
---
...
**언어:** TypeScript | **⭐ Stars:** 320,496

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 320,496개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 124,135

The open source coding agent.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 124,135개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 98,133

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 98,133개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 95,996

Public repository for Agent Skills

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 95,996개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
