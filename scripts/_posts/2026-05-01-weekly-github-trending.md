...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.05.01)
---
...
**언어:** TypeScript | **⭐ Stars:** 366,819

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 366,819개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Shell | **⭐ Stars:** 174,641

An agentic skills framework & software development methodology that works.

**주요 특징:**
- 최근 주목받고 있는 Shell 프로젝트
- 174,641개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 152,649

The open source coding agent.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 152,649개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
