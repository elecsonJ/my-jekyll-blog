...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.05.08)
---
...
**언어:** TypeScript | **⭐ Stars:** 369,487

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 369,487개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Shell | **⭐ Stars:** 182,037

An agentic skills framework & software development methodology that works.

**주요 특징:**
- 최근 주목받고 있는 Shell 프로젝트
- 182,037개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 156,546

The open source coding agent.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 156,546개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
