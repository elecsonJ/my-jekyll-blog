...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.01.30)
---
...
**언어:** TypeScript | **⭐ Stars:** 92,283

The open source coding agent.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 92,283개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 58,076

Public repository for Agent Skills

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 58,076개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 53,906

No fortress, purely open ground.  OpenManus is Coming.

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 53,906개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 45,357

The open-source CapCut alternative

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 45,357개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 44,100

Context7 MCP Server -- Up-to-date code documentation for LLMs and AI code editors

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 44,100개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
