...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2025.06.27)
---
...
**언어:** None | **⭐ Stars:** 90,278

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 90,278개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 47,297

No fortress, purely open ground.  OpenManus is Coming.

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 47,297개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 29,863

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 29,863개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
