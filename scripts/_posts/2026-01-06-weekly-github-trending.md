...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.01.06)
---
...
**언어:** None | **⭐ Stars:** 91,646

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,646개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 89,764

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 89,764개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 60,080

💫 Toolkit to help you get started with Spec-Driven Development

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 60,080개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 55,282

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 55,282개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
