...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2025.12.24)
---
...
**언어:** None | **⭐ Stars:** 91,593

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,593개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 88,401

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 88,401개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 57,365

💫 Toolkit to help you get started with Spec-Driven Development

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 57,365개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 54,585

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 54,585개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
