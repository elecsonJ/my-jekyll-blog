...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.02.07)
---
...
**언어:** TypeScript | **⭐ Stars:** 171,337

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 171,337개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 99,251

The open source coding agent.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 99,251개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 93,820

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 93,820개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** None | **⭐ Stars:** 91,832

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,832개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
