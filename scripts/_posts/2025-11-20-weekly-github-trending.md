...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2025.11.20)
---
...
**언어:** None | **⭐ Stars:** 91,492

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,492개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 83,516

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 83,516개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 50,920

No fortress, purely open ground.  OpenManus is Coming.

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 50,920개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 50,893

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 50,893개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
