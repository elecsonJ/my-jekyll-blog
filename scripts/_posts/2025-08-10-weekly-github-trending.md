...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2025.08.10)
---
...
**언어:** None | **⭐ Stars:** 90,822

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 90,822개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 68,318

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 68,318개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 48,846

No fortress, purely open ground.  OpenManus is Coming.

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 48,846개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
