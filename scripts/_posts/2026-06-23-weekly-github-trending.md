...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.06.23)
---
...
**언어:** TypeScript | **⭐ Stars:** 379,983

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 379,983개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Shell | **⭐ Stars:** 236,096

An agentic skills framework & software development methodology that works.

**주요 특징:**
- 최근 주목받고 있는 Shell 프로젝트
- 236,096개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 200,018

The agent that grows with you

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 200,018개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 194,172

An agent-managed museum exhibit, built in Rust with Gajae-Code / LazyCodex — developed and maintained with no human intervention.

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 194,172개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
