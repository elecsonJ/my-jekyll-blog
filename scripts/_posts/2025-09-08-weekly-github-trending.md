...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2025.09.08)
---
...
**언어:** None | **⭐ Stars:** 91,042

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,042개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 74,049

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 74,049개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 49,488

No fortress, purely open ground.  OpenManus is Coming.

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 49,488개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 39,278

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 39,278개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
