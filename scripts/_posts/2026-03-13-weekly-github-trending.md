...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.03.13)
---
...
**언어:** TypeScript | **⭐ Stars:** 307,770

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 307,770개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 121,006

The open source coding agent.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 121,006개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 97,441

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 97,441개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** None | **⭐ Stars:** 91,964

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,964개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
