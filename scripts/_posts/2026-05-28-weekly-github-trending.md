...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.05.28)
---
...
**언어:** TypeScript | **⭐ Stars:** 375,111

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 375,111개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Shell | **⭐ Stars:** 209,658

An agentic skills framework & software development methodology that works.

**주요 특징:**
- 최근 주목받고 있는 Shell 프로젝트
- 209,658개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 170,374

The agent that grows with you

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 170,374개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
