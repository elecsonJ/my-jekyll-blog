...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.05.30)
---
...
**언어:** TypeScript | **⭐ Stars:** 375,523

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 375,523개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 172,900

The agent that grows with you

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 172,900개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 167,174

The open source coding agent.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 167,174개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
