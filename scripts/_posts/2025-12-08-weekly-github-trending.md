...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2025.12.08)
---
...
**언어:** None | **⭐ Stars:** 91,557

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,557개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 86,216

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 86,216개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 53,901

💫 Toolkit to help you get started with Spec-Driven Development

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 53,901개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 52,106

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 52,106개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
