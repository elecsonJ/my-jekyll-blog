...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.03.24)
---
...
**언어:** TypeScript | **⭐ Stars:** 332,365

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 332,365개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 128,868

The open source coding agent.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 128,868개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 101,038

Public repository for Agent Skills

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 101,038개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
