...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.03.25)
---
...
**언어:** TypeScript | **⭐ Stars:** 334,444

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 334,444개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 98,959

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 98,959개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
