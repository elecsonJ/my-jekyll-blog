...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2025.12.04)
---
...
**언어:** None | **⭐ Stars:** 91,543

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,543개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 85,682

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 85,682개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 53,097

💫 Toolkit to help you get started with Spec-Driven Development

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 53,097개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 51,703

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 51,703개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
