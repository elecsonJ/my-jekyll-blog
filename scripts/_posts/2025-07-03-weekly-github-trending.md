...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2025.07.03)
---
...
**언어:** None | **⭐ Stars:** 90,350

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 90,350개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 50,111

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 50,111개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 47,507

No fortress, purely open ground.  OpenManus is Coming.

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 47,507개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
