...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.04.28)
---
...
**언어:** TypeScript | **⭐ Stars:** 365,390

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 365,390개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 150,717

The open source coding agent.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 150,717개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
