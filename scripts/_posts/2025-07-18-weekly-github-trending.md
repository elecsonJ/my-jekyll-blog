...
**언어:** None | **⭐ Stars:** 90,585

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 90,585개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 60,860

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 60,860개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 48,089

No fortress, purely open ground.  OpenManus is Coming.

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 48,089개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
