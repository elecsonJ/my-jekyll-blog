...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2025.07.04)
---
...
**언어:** None | **⭐ Stars:** 90,371

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 90,371개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 51,506

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 51,506개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 47,546

No fortress, purely open ground.  OpenManus is Coming.

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 47,546개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
