...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.01.23)
---
...
**언어:** TypeScript | **⭐ Stars:** 92,130

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 92,130개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 56,865

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 56,865개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 53,452

No fortress, purely open ground.  OpenManus is Coming.

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 53,452개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 50,274

all of the workflows of n8n i could find (also from the site itself)

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 50,274개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
