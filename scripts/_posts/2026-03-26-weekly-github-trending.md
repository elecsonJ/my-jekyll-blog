...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.03.26)
---
...
**언어:** TypeScript | **⭐ Stars:** 335,989

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 335,989개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 102,908

Public repository for Agent Skills

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 102,908개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 99,096

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 99,096개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
