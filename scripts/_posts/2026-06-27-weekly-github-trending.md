...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.06.27)
---
...
**언어:** TypeScript | **⭐ Stars:** 380,621

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 380,621개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Shell | **⭐ Stars:** 239,466

An agentic skills framework & software development methodology that works.

**주요 특징:**
- 최근 주목받고 있는 Shell 프로젝트
- 239,466개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** JavaScript | **⭐ Stars:** 222,206

The agent harness performance optimization system. Skills, instincts, memory, security, and research-first development for Claude Code, Codex, Opencode, Cursor and beyond.

**주요 특징:**
- 최근 주목받고 있는 JavaScript 프로젝트
- 222,206개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구

---

### 4. [claw-code](https://github.com/ultraworkers/claw-code)

**언어:** Rust | **⭐ Stars:** 194,344

An agent-managed museum exhibit, built in Rust with Gajae-Code / LazyCodex — developed and maintained with no human intervention.

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 194,344개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구

---

### 5. [andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills)

**언어:** None | **⭐ Stars:** 182,894

A single CLAUDE.md file to improve Claude Code behavior, derived from Andrej Karpathy's observations on LLM coding pitfalls.

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 182,894개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
