...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2025.12.25)
---
...
**언어:** None | **⭐ Stars:** 91,600

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,600개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 88,538

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 88,538개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 57,587

💫 Toolkit to help you get started with Spec-Driven Development

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 57,587개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 54,636

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 54,636개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
