...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.06.03)
---
...
**언어:** TypeScript | **⭐ Stars:** 376,311

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 376,311개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Shell | **⭐ Stars:** 215,996

An agentic skills framework & software development methodology that works.

**주요 특징:**
- 최근 주목받고 있는 Shell 프로젝트
- 215,996개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 177,531

The agent that grows with you

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 177,531개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
