...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.06.24)
---
...
**언어:** Shell | **⭐ Stars:** 237,001

An agentic skills framework & software development methodology that works.

**주요 특징:**
- 최근 주목받고 있는 Shell 프로젝트
- 237,001개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 201,029

The agent that grows with you

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 201,029개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 194,219

An agent-managed museum exhibit, built in Rust with Gajae-Code / LazyCodex — developed and maintained with no human intervention.

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 194,219개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** None | **⭐ Stars:** 181,053

A single CLAUDE.md file to improve Claude Code behavior, derived from Andrej Karpathy's observations on LLM coding pitfalls.

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 181,053개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
