...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2025.12.12)
---
...
**언어:** None | **⭐ Stars:** 91,579

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,579개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 86,933

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 86,933개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 54,847

💫 Toolkit to help you get started with Spec-Driven Development

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 54,847개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 52,328

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 52,328개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
