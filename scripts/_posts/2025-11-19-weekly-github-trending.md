...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2025.11.19)
---
...
**언어:** None | **⭐ Stars:** 91,497

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,497개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 83,104

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 83,104개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 50,903

No fortress, purely open ground.  OpenManus is Coming.

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 50,903개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 50,825

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 50,825개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
