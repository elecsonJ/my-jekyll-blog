...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.01.04)
---
...
**언어:** None | **⭐ Stars:** 91,639

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,639개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 89,537

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 89,537개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 59,387

💫 Toolkit to help you get started with Spec-Driven Development

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 59,387개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 55,154

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 55,154개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
