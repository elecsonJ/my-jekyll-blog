...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.03.04)
---
...
**언어:** TypeScript | **⭐ Stars:** 254,249

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 254,249개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 115,157

The open source coding agent.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 115,157개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 96,348

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 96,348개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** None | **⭐ Stars:** 91,904

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,904개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
