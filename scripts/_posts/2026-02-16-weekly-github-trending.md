...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.02.16)
---
...
**언어:** TypeScript | **⭐ Stars:** 105,127

The open source coding agent.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 105,127개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** None | **⭐ Stars:** 91,851

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,851개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 70,265

Public repository for Agent Skills

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 70,265개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구

---

### 4. [spec-kit](https://github.com/github/spec-kit)

**언어:** Python | **⭐ Stars:** 69,859

💫 Toolkit to help you get started with Spec-Driven Development

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 69,859개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구

---

### 5. [OpenManus](https://github.com/FoundationAgents/OpenManus)

**언어:** Python | **⭐ Stars:** 54,483

No fortress, purely open ground.  OpenManus is Coming.

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 54,483개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
