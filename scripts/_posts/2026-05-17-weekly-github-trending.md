...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.05.17)
---
...
**언어:** TypeScript | **⭐ Stars:** 372,466

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 372,466개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 104,138

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 104,138개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
