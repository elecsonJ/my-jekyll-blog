...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2025.12.09)
---
...
**언어:** None | **⭐ Stars:** 91,564

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,564개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 86,378

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 86,378개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 54,117

💫 Toolkit to help you get started with Spec-Driven Development

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 54,117개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 52,156

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 52,156개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
