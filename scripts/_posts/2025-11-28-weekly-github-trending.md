...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2025.11.28)
---
...
**언어:** TypeScript | **⭐ Stars:** 84,938

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 84,938개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 51,773

💫 Toolkit to help you get started with Spec-Driven Development

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 51,773개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 51,376

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 51,376개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 51,032

No fortress, purely open ground.  OpenManus is Coming.

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 51,032개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
