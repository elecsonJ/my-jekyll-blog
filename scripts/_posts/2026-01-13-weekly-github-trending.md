...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.01.13)
---
...
**언어:** None | **⭐ Stars:** 91,691

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,691개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 90,659

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 90,659개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 61,971

💫 Toolkit to help you get started with Spec-Driven Development

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 61,971개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 55,991

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 55,991개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
