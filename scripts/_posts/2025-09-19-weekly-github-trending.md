...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2025.09.19)
---
...
**언어:** None | **⭐ Stars:** 91,130

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,130개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 75,739

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 75,739개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 49,849

No fortress, purely open ground.  OpenManus is Coming.

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 49,849개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 42,583

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 42,583개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
