...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.02.19)
---
...
**언어:** TypeScript | **⭐ Stars:** 208,878

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 208,878개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 106,642

The open source coding agent.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 106,642개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 94,818

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 94,818개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** None | **⭐ Stars:** 91,844

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,844개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
