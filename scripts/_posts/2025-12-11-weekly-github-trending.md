...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2025.12.11)
---
...
**언어:** None | **⭐ Stars:** 91,577

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,577개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 54,600

💫 Toolkit to help you get started with Spec-Driven Development

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 54,600개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 52,270

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 52,270개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구

---

### 4. [n8n-workflows](https://github.com/Zie619/n8n-workflows)

**언어:** Python | **⭐ Stars:** 47,470

all of the workflows of n8n i could find (also from the site itself)

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 47,470개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
