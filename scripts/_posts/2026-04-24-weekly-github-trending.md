...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2026.04.24)
---
...
**언어:** TypeScript | **⭐ Stars:** 362,984

Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞 

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 362,984개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 102,265

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 102,265개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 77,362

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 77,362개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 76,045

AI agents running research on single-GPU nanochat training automatically

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 76,045개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
