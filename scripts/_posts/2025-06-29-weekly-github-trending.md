...
**언어:** None | **⭐ Stars:** 90,298

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 90,298개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 47,373

No fortress, purely open ground.  OpenManus is Coming.

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 47,373개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 40,633

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 40,633개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
