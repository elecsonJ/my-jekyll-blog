...
- opensource
- development
title: 이번 주 GitHub 트렌딩 프로젝트 (2025.12.29)
---
...
**언어:** None | **⭐ Stars:** 91,616

None

**주요 특징:**
- 최근 주목받고 있는 None 프로젝트
- 91,616개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** TypeScript | **⭐ Stars:** 88,926

An open-source AI agent that brings the power of Gemini directly into your terminal.

**주요 특징:**
- 최근 주목받고 있는 TypeScript 프로젝트
- 88,926개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Python | **⭐ Stars:** 58,275

💫 Toolkit to help you get started with Spec-Driven Development

**주요 특징:**
- 최근 주목받고 있는 Python 프로젝트
- 58,275개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
...
**언어:** Rust | **⭐ Stars:** 54,839

Lightweight coding agent that runs in your terminal

**주요 특징:**
- 최근 주목받고 있는 Rust 프로젝트
- 54,839개의 스타를 획득하며 빠른 성장세
- 실무 적용 가능성이 높은 도구
